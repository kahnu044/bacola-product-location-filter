...
class BPLF_Dependencies {
    ...
    public static function woocommerce_missing() {
        ...
        echo esc_html__( 'Bacola Location Product Control requires WooCommerce to be installed and active.', 'blpc' );
        echo '</p></div>';
    }

    public static function theme_missing() {
        echo '<div class="notice notice-warning"><p>';
        echo esc_html__( 'This plugin is designed for the Bacola theme. Some features may not work properly.', 'blpc' );
        echo '</p></div>';
    }
}
